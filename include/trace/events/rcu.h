...
#define trace_rcu_grace_period(rcuname, gp_seq, gpevent) ((void)0)
...
#define trace_rcu_exp_funnel_lock(rcuname, level, grplo, grphi, gpevent) \
	((void)0)
#define trace_rcu_nocb_wake(rcuname, cpu, reason) ((void)0)
#define trace_rcu_preempt_task(rcuname, pid, gp_seq) ((void)0)
#define trace_rcu_unlock_preempted_task(rcuname, gp_seq, pid) ((void)0)
#define trace_rcu_quiescent_state_report(rcuname, gp_seq, mask, qsmask, level, \
					 grplo, grphi, gp_tasks) do { } \
	while (0)
#define trace_rcu_fqs(rcuname, gp_seq, cpu, qsevent) ((void)0)
#define trace_rcu_dyntick(polarity, oldnesting, newnesting, dyntick) ((void)0)
#define trace_rcu_callback(rcuname, rhp, qlen_lazy, qlen) ((void)0)
#define trace_rcu_kfree_callback(rcuname, rhp, offset, qlen_lazy, qlen) \
	((void)0)
#define trace_rcu_batch_start(rcuname, qlen_lazy, qlen, blimit) \
	((void)0)
#define trace_rcu_invoke_callback(rcuname, rhp) ((void)0)
#define trace_rcu_invoke_kfree_callback(rcuname, rhp, offset) ((void)0)
#define trace_rcu_batch_end(rcuname, callbacks_invoked, cb, nr, iit, risk) \
	((void)0)
#define trace_rcu_torture_read(rcutorturename, rhp, secs, c_old, c) \
	((void)0)
#define trace_rcu_barrier(name, s, cpu, cnt, done) ((void)0)
