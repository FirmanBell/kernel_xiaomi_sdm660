...
#elif defined(CONFIG_MACH_XIAOMI_WHYRED) || defined(CONFIG_MACH_XIAOMI_TULIP) || defined(CONFIG_MACH_XIAOMI_PLATINA)
...
#if defined(CONFIG_MACH_XIAOMI_WAYNE) || defined(CONFIG_MACH_XIAOMI_TULIP) || defined(CONFIG_MACH_XIAOMI_LAVENDER) || defined(CONFIG_MACH_XIAOMI_PLATINA)
			vote(chg->usb_icl_votable, LEGACY_UNKNOWN_VOTER, true,
					1000000);
#else
			vote(chg->usb_icl_votable, LEGACY_UNKNOWN_VOTER, true,
