...
static void status_change_work(struct work_struct *work)
{
	...
	union power_supply_propval prop = {0, };
	int rc, batt_temp;
#if defined(CONFIG_MACH_XIAOMI_LAVENDER) || defined(CONFIG_MACH_XIAOMI_WAYNE) || defined(CONFIG_MACH_XIAOMI_PLATINA)
	int msoc;
#endif
...
#if defined(CONFIG_MACH_XIAOMI_WAYNE) || defined(CONFIG_MACH_XIAOMI_PLATINA)
		buf[0] = 0x8;
#endif
		rc = fg_sram_write(fg,
