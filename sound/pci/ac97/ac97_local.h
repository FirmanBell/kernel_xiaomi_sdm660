...
#else
#define snd_ac97_bus_proc_init(ac97_bus_t) ((void)0)
#define snd_ac97_bus_proc_done(ac97_bus_t) ((void)0)
#define snd_ac97_proc_init(ac97_t) ((void)0)
#define snd_ac97_proc_done(ac97_t) ((void)0)
#endif
